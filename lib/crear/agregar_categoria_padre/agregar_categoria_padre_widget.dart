...
import 'agregar_categoria_padre_model.dart';
export 'agregar_categoria_padre_model.dart';

class AgregarCategoriaPadreWidget extends StatefulWidget {
  const AgregarCategoriaPadreWidget({
    super.key,
    this.colorInicio,
    this.colorOrdenes,
    this.colorProductos,
  ...
  @override
  State<AgregarCategoriaPadreWidget> createState() =>
      _AgregarCategoriaPadreWidgetState();
}

class _AgregarCategoriaPadreWidgetState
    extends State<AgregarCategoriaPadreWidget> {
  late AgregarCategoriaPadreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarCategoriaPadreModel());
                                      ...
                                      child: Container(
                                        ...
                                        child: StreamBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<CategoriaPadreRecord>
                                                columnCategoriaPadreRecordList =
                                                snapshot.data!;
                                            final columnCategoriaPadreRecord =
                                                columnCategoriaPadreRecordList
                                                        .isNotEmpty
                                                    ? columnCategoriaPadreRecordList
                                                        .first
                                              ...
                                              children: [
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    ...
                                                    await CategoriaPadreRecord
                                                        .collection
                                                        .doc()
                                                        .set(
                                                            createCategoriaPadreRecordData(
