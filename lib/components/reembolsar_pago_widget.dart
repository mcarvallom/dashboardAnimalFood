...
class ReembolsarPagoWidget extends StatefulWidget {
  const ReembolsarPagoWidget({Key? key}) : super(key: key);

  @override
  _ReembolsarPagoWidgetState createState() => _ReembolsarPagoWidgetState();
}

class _ReembolsarPagoWidgetState extends State<ReembolsarPagoWidget> {
  late ReembolsarPagoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReembolsarPagoModel());
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (confirmDialogResponse) {
                                      ...
                                      _model.apiReembolso =
                                          await GetNetGroup.reembolsoCall.call(
                                        login:
                                            '7ffbb7bf1f7361b1200b2e8d74e1d76f',
                                        tranKey: _model.tranKey,
                                        nonce: _model.nonceEncriptado,
                                        seed: FFAppState().seed,
                                        internalReference:
