...
import 'barra_menu_model.dart';
export 'barra_menu_model.dart';

class BarraMenuWidget extends StatefulWidget {
  const BarraMenuWidget({super.key});

  @override
  State<BarraMenuWidget> createState() => _BarraMenuWidgetState();
}

class _BarraMenuWidgetState extends State<BarraMenuWidget> {
  late BarraMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BarraMenuModel());
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: valueOrDefault<Color>(
                            FFAppState().nombrePagina == 'Inicio'
