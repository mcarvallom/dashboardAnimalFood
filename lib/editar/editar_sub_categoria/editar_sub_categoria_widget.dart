...
import 'editar_sub_categoria_model.dart';
export 'editar_sub_categoria_model.dart';
...
class _EditarSubCategoriaWidgetState extends State<EditarSubCategoriaWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CategoryRecord>(
      stream: CategoryRecord.getDocument(widget.etiqueta!),
      builder: (context, snapshot) {
        ...
        final editarSubCategoriaCategoryRecord = snapshot.data!;
                                                              ...
                                                              image:
                                                                ...
                                                                image: Image
                                                                  ...
                                                                  _model.isDataUploading
                                                                      ? _model
                                                                          .uploadedFileUrl
                                                                      : editarSubCategoriaCategoryRecord
                                                                          .imagen,
                                                                ).image,
                                                              ),
                                                              borderRadius:
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              controller: _model
                                                                ...
                                                                text: editarSubCategoriaCategoryRecord
                                                                    .nombreEtiqueta,
                                                              ),
                                                              focusNode: _model
                                                                  .textFieldFocusNode,
