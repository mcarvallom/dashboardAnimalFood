...
class EditarPortadaPerfilWidget extends StatefulWidget {
  const EditarPortadaPerfilWidget({super.key});

  @override
  State<EditarPortadaPerfilWidget> createState() =>
      _EditarPortadaPerfilWidgetState();
}

class _EditarPortadaPerfilWidgetState extends State<EditarPortadaPerfilWidget> {
  late EditarPortadaPerfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPortadaPerfilModel());
