                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Flexible(
                                child: StreamBuilder<CategoriaPadreRecord>(
                                  stream: CategoriaPadreRecord.getDocument(
                                      widget.categoria!),
                                  builder: (context, snapshot) {
                                    ...
                                    final containerCategoriaPadreRecord =
                                        snapshot.data!;
                                    return Container(
                                      decoration: BoxDecoration(),
                                      child: Column(
                                                ...
                                                Padding(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                      ...
                                                      text: containerCategoriaPadreRecord
                                            ...
                                            Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  await widget.categoria!.update(
                                                      createCategoriaPadreRecordData(
                                                    nombreCategoriaPadre: _model
                                                        .tituloMovilTextController
                                                        .text,
                                                    imagen: FFAppState()
                                                                .isImagenSubida ==
