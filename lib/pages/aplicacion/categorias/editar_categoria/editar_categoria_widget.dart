                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          10.0, 5.0, 10.0, 5.0),
                                      child:
                                          StreamBuilder<CategoriaPadreRecord>(
                                        stream:
                                            CategoriaPadreRecord.getDocument(
                                                widget.categoria!),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                        ...
                                        onPressed: () async {
                                          ...
                                          setState(() {
                                            FFAppState().imagenSubida =
                                                _model.uploadedFileUrl1;
                                            FFAppState().isImagenSubida = true;
                                          });
                                        },
                                        text: 'Subir imagen',
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          setState(() {
                                            FFAppState().imagenSubida = '';
                                            FFAppState().isImagenSubida = false;
                                          });
                                          context.safePop();
                                        },
                                        text: 'Publicar',
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await widget.categoria!
                                        .update(createCategoriaPadreRecordData(
                                      nombreCategoriaPadre:
                                          _model.tituloMovilController.text,
