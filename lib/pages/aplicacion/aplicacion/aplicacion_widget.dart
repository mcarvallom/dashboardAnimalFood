...
import 'aplicacion_model.dart';
export 'aplicacion_model.dart';

class AplicacionWidget extends StatefulWidget {
  const AplicacionWidget({
    super.key,
    Color? colorInicio,
    String? nombre,
  ...
  @override
  State<AplicacionWidget> createState() => _AplicacionWidgetState();
}

class _AplicacionWidgetState extends State<AplicacionWidget> {
  late AplicacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AplicacionModel());
