...
class AgregarProdRecomendadoWidget extends StatefulWidget {
  ...
  @override
  _AgregarProdRecomendadoWidgetState createState() =>
...
class _AgregarProdRecomendadoWidgetState
  ...
  void initState() {
    ...
    _model.buscarController ??= TextEditingController();

    _model.titulomovilController ??= TextEditingController();
    _model.titulomovilFocusNode ??= FocusNode();

    _model.subtituloMovilController ??= TextEditingController();
    _model.subtituloMovilFocusNode ??= FocusNode();

    _model.buscarMovilController ??= TextEditingController();
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await RecomendadoRecord.collection
                                              .doc()
                                              .set(createRecomendadoRecordData(
                                                titulo: _model
                                    ...
                                    children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .titulomovilController,
                                                focusNode:
                                                    _model.titulomovilFocusNode,
                                                onChanged: (_) =>
                                                    EasyDebounce.debounce(
                                                  '_model.titulomovilController',
                                                  Duration(milliseconds: 200),
                                                  () => setState(() {}),
                                                ),
                                                autofocus: true,
                                                ...
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium,
                                                validator: _model
                                                    .titulomovilControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .subtituloMovilController,
                                                focusNode: _model
                                                    .subtituloMovilFocusNode,
                                                onChanged: (_) =>
                                                    EasyDebounce.debounce(
                                                  '_model.subtituloMovilController',
                                                  Duration(milliseconds: 200),
                                                  () => setState(() {}),
                                                ),
                                                autofocus: true,
                                                ...
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium,
                                                validator: _model
                                                    .subtituloMovilControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ],
                                            ...
                                            return Container(
                                              ...
                                              child: Autocomplete<String>(
                                                ...
                                                fieldViewBuilder: (
                                                  ...
                                                  _model.buscarMovilController =
                                                      textEditingController;
                                                  return TextFormField(
                                                    key: _model.buscarMovilKey,
                                                    controller:
                                                        textEditingController,
                                                    focusNode: focusNode,
                                                    onEditingComplete:
                                                    ...
                                                    style: FlutterFlowTheme.of(
                                                        ...
                                                        .bodyMedium,
                                                    validator: _model
                                                        .buscarMovilControllerValidator
                                                        .asValidator(context),
                                                  );
                                                },
                                              ),
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 20.0, 0.0, 0.0),
                                        child: Text(
                                          _model.buscarMovilController.text,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                        ),
                                      ),
