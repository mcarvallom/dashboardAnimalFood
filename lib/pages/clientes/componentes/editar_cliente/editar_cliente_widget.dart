...
class _EditarClienteWidgetState extends State<EditarClienteWidget> {
  ...
  void initState() {
    ...
    _model.apellidoclienteTextController ??=
        TextEditingController(text: widget.user?.apellido);
    _model.apellidoclienteFocusNode ??= FocusNode();

    _model.runTextController ??=
        TextEditingController(text: widget.user?.run.toString());
    _model.runFocusNode ??= FocusNode();

    _model.runMask = MaskTextInputFormatter(mask: '########');
    _model.dvTextController ??= TextEditingController(text: widget.user?.dv);
    _model.dvFocusNode ??= FocusNode();

    _model.direccionTextController ??=
        TextEditingController(text: widget.user?.direccion);
    _model.direccionFocusNode ??= FocusNode();

    _model.numcontactoTextController ??=
        TextEditingController(text: widget.user?.numeroContacto.toString());
    _model.numcontactoFocusNode ??= FocusNode();

    _model.numcontactoMask = MaskTextInputFormatter(mask: '#########');
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .apellidoclienteTextController,
                                          focusNode:
                                              _model.apellidoclienteFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.next,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      FutureBuilder<List<CiudadRow>>(
                                        future: _model.ciudades(
                                          requestFn: () =>
                                              CiudadTable().queryRows(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (functions.validarRut(
                                              int.parse(_model
                                                  .runTextController.text),
                                              _model.dvTextController.text)) {
                                              ...
                                              data: {
                                                ...
                                                'numeroContacto':
                                                    double.tryParse(_model
                                                        .numcontactoTextController
                                                        .text),
                                                'direccion': _model
                                                    .direccionTextController
                                                    .text,
                                                'run': double.tryParse(_model
                                                    .runTextController.text),
                                                'dv': _model
                                                    .dvTextController.text,
                                                'nombreCompleto':
                                                    '${_model.nombreTextController.text} ${_model.apellidoclienteTextController.text}',
                                                'region': 6,
                                                'ciudad': _model.ciudadValue,
                                                'sucursal':
                                                    '9e52e727-49c6-4e6d-9686-130c80301a29',
                                              },
                                              matchingRows: (rows) =>
                                                  rows.eqOrNull(
                                                'id',
