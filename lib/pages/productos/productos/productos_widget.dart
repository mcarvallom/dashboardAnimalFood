...
import '/pages/productos/componentes/opciones_producto/opciones_producto_widget.dart';
import '/pages/productos/componentes/sin_productos/sin_productos_widget.dart';
                ...
                child: Row(
                  ...
                  children: [
                    FutureBuilder<List<CategoraRow>>(
                      future: _model.categoriaProducto(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CategoraRow> dropDownCategoraRowList =
                            snapshot.data!;
                        ...
                        return FlutterFlowDropDown<String>(
                          controller: _model.dropDownValueController ??=
                            ...
                            _model.dropDownValue ??=
                                dropDownCategoraRowList.firstOrNull?.nombre,
                          ),
                          options: dropDownCategoraRowList
                              .map((e) => e.nombre)
                              .toList(),
                          onChanged: (val) async {
                            safeSetState(() => _model.dropDownValue = val);
                            safeSetState(() {
                              _model.clearProductosCache();
                          ...
                          elevation: 2.0,
                          borderColor: FlutterFlowTheme.of(context).bordeGris,
                          borderWidth: 1.0,
                          borderRadius: 8.0,
                ...
                child: FutureBuilder<List<ProductoRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return Container(
                      ...
                      child: Builder(
                        builder: (context) {
                          final productos = containerProductoRowList.toList();
                          if (productos.isEmpty) {
                            return SinProductosWidget();
                          }
                          ...
                          return FlutterFlowDataTable<ProductoRow>(
                                          ...
                                          builder: (dialogContext) {
                                            return Dialog(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                child: OpcionesProductoWidget(
                                                  producto: productosItem,
                                                ),
                                              ),
                                            );
                                          },
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      'Stock: ${functions.ponerPuntoalMil(functions.doubleToInt(productosItem.stock!).toString())}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                                    ...
                                                    Text(
                                                      '\$${functions.ponerPuntoalMil(productosItem.precio.toString())}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                            ...
                            emptyBuilder: () => SinProductosWidget(),
                            paginated: true,
                            selectable: false,
                            hidePaginator: false,
