...
import 'ver_mi_ticket_model.dart';
export 'ver_mi_ticket_model.dart';

class VerMiTicketWidget extends StatefulWidget {
  const VerMiTicketWidget({
    super.key,
  ...
  @override
  State<VerMiTicketWidget> createState() => _VerMiTicketWidgetState();
}

class _VerMiTicketWidgetState extends State<VerMiTicketWidget> {
  late VerMiTicketModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerMiTicketModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<SoporteRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final verMiTicketSoporteRecord = snapshot.data!;
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 8.0),
                                child: Text(
                                  verMiTicketSoporteRecord.nombreCompleto,
                                  style: FlutterFlowTheme.of(context)
                                      .headlineMedium
                                      .override(
                                        fontFamily: 'Outfit',
                              ...
                              Text(
                                verMiTicketSoporteRecord.email,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 12.0),
                                  child: Text(
                                    verMiTicketSoporteRecord.mensaje,
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
                                  ...
                                  onPressed: () async {
                                    ...
                                    _model.usuario = await queryUserRecordOnce(
                                      queryBuilder: (userRecord) =>
                                        ...
                                        'uid',
                                        isEqualTo:
                                            verMiTicketSoporteRecord.usuarioUID,
                                      ),
                                      singleRecord: true,
                                    ).then((s) => s.firstOrNull);
                                    await actions.sendNotificationAdminSoporte(
                                      _model.textController.text,
                    ...
                    wrapWithModel(
                      ...
                      child: PreguntasYRespuestasWidget(
                        parameter6: verMiTicketSoporteRecord.mensajeRespuesta,
                      ),
                    ),
                  ],
                ),
