...
import 'mis_tickets_model.dart';
export 'mis_tickets_model.dart';

class MisTicketsWidget extends StatefulWidget {
  const MisTicketsWidget({super.key});

  @override
  State<MisTicketsWidget> createState() => _MisTicketsWidgetState();
}

class _MisTicketsWidgetState extends State<MisTicketsWidget> {
  late MisTicketsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MisTicketsModel());
