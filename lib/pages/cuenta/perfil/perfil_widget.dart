...
import '/pages/cuenta/componentes/crear_usuario/crear_usuario_widget.dart';
import '/pages/cuenta/componentes/editar_usuario/editar_usuario_widget.dart';
import '/index.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      '${valueOrDefault<String>(
                        perfilUserRow?.nombre,
                        'Sin nombre',
                      )} ${valueOrDefault<String>(
                        perfilUserRow?.apellido,
                        'Sin apellido',
                      )}',
                      style:
                  ...
                  if (perfilUserRow?.rol == 'Administrador')
                    Builder(
                      builder: (context) => Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 12.0, 16.0, 0.0),
                      ...
                      onTap: () async {
                        ...
                        if (confirmDialogResponse) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Tu cuenta quedó inactiva y se elimiará dentro de 30 días.',
                                style: TextStyle(
                                  color: FlutterFlowTheme.of(context)
                                      .secondaryBackground,
                                ),
