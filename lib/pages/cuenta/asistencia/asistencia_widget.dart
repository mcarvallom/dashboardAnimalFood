                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          'Marcar mi registro de asistencia.',
                                              ...
                                              onPressed: () async {
                                                currentUserLocationValue =
                                                    await getCurrentUserLocation(
                                                        defaultLocation:
                                                            LatLng(0.0, 0.0));
                                                _model.asistenciaQuery =
                                                    await AsistenciaTable()
                                                        .queryRows(
                                                  queryFn: (q) => q
                                                      .eqOrNull(
                                                        'empresa',
                                                ...
                                                if ((dateTimeFormat(
                                                  ...
                                                  if (confirmDialogResponse) {
                                                    await AsistenciaTable()
                                                        .insert({
                                                      'horaIngreso': supaSerialize<
                                                              DateTime>(
                                                          getCurrentTimestamp),
                                                      'user': currentUserUid,
                                                      'empresa': FFAppConstants
                                                          .empresa,
                                                      'sucursal':
                                                          '9e52e727-49c6-4e6d-9686-130c80301a29',
                                                      'lugarEntrada':
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Column(
                                      ...
                                      children: List.generate(
                                          columnAsistenciaRowList.length,
                                          (columnIndex) {
                                        final columnAsistenciaRow =
                                            columnAsistenciaRowList[
                                                columnIndex];
                                        return Expanded(
                                          child: Padding(
