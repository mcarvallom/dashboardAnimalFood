...
class _CrearUsuarioWidgetState extends State<CrearUsuarioWidget> {
  ...
  void initState() {
    ...
    _model.apellidousuarioTextController ??= TextEditingController();
    _model.apellidousuarioFocusNode ??= FocusNode();
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .apellidousuarioTextController,
                                          focusNode:
                                              _model.apellidousuarioFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.next,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.contraseaTextController,
                                          ...
                                          if (functions.validarRut(
                                            ...
                                            await UserTable().insert({
                                              ...
                                              'dv':
                                                  _model.dvTextController.text,
                                              'nombreCompleto':
                                                  '${_model.nombreTextController.text} ${_model.apellidousuarioTextController.text}',
                                              'region': 6,
                                              ...
                                              'correoUser':
                                                  '${functions.antesdearroba(_model.correoTextController.text)}${FFAppConstants.empresa.toString()}@${functions.despuesdearroba(_model.correoTextController.text)}',
                                            });
                                            _model.crearusuario =
                                                await CrearUsuarioSupabaseAuthCall
                                                    .call(
                                              email:
                                                  '${functions.antesdearroba(_model.correoTextController.text)}${FFAppConstants.empresa.toString()}@${functions.despuesdearroba(_model.correoTextController.text)}',
                                              password: _model
                                                  .contraseaTextController.text,
                                              nombre: _model
                                                  .nombreTextController.text,
                                              apellido: _model
                                                  .apellidousuarioTextController
