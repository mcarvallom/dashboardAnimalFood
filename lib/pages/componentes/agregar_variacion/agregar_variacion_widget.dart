...
class AgregarVariacionWidget extends StatefulWidget {
  const AgregarVariacionWidget({super.key});

  @override
  State<AgregarVariacionWidget> createState() => _AgregarVariacionWidgetState();
}

class _AgregarVariacionWidgetState extends State<AgregarVariacionWidget> {
  late AgregarVariacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarVariacionModel());
