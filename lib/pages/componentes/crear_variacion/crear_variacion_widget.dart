...
import 'crear_variacion_model.dart';
export 'crear_variacion_model.dart';

class CrearVariacionWidget extends StatefulWidget {
  const CrearVariacionWidget({
    super.key,
    this.producto,
  });
  ...
  @override
  State<CrearVariacionWidget> createState() => _CrearVariacionWidgetState();
}

class _CrearVariacionWidgetState extends State<CrearVariacionWidget> {
  late CrearVariacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearVariacionModel());
    ...
    _model.txtRebajaTextController ??= TextEditingController();
    _model.txtRebajaFocusNode ??= FocusNode();

    _model.txtCodigoBarraTextController ??= TextEditingController();
    _model.txtCodigoBarraFocusNode ??= FocusNode();
              ...
              return [
                      ...
                      children: [
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            focusNode: _model.txtCodigoBarraFocusNode,
                            autofocus: true,
                            obscureText: false,
                            decoration: InputDecoration(
                ...
                () => Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await VariacionRecord.createDoc(widget.producto!)
