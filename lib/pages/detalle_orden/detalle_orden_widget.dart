                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          24.0, 10.0, 0.0, 0.0),
                                      child: Text(
                                        'A continuación se muestra el detalle de la orden.',
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        style: FlutterFlowTheme.of(context)
                                                                            ...
                                                                            .override(
                                                                              fontFamily: 'Readex Pro',
                                                                              color: () {
                                                                                if (columnOrderRecord.status == 'En proceso') {
                                                                                  return FlutterFlowTheme.of(context).tertiary;
                                                                                } else if (columnOrderRecord.status == 'Preparando envío') {
                                                                                  return Color(0xFF39D2C0);
                                                                                } else if (columnOrderRecord.status == 'En camino') {
                                                                                  return Color(0xFFF76631);
                                                                                } else if (columnOrderRecord.status == 'Entregado') {
                                                                                  return FlutterFlowTheme.of(context).success;
                                                                                } else if (columnOrderRecord.status == 'Fallo en la entrega') {
                                                                                  return FlutterFlowTheme.of(context).error;
                                                                                } else if (columnOrderRecord.status == 'Pendiente de pago') {
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Align(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(10.0, 10.0, 0.0, 10.0),
                                                                                    child: Text(
                                                                                      columnOrderRecord.nombrePagador,
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: 'Readex Pro',
                                                                                            fontSize: 16.0,
                                                                                            fontWeight: FontWeight.w300,
                                                                  ...
                                                                  return ListView
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return StreamBuilder<
                                                                          SelectedItemsRecord>(
                                                                        stream:
                                                                            SelectedItemsRecord.getDocument(productosListaItem),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
