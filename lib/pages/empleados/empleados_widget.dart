                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (FFAppState().busquedaActiva == false)
                              Expanded(
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                                                  ...
                                                                  [
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                          SwitchAdminWidget(
                                                                        key: Key(
                                                                            'Key5ie_${dataTableIndex}_of_${dataTableUserRecordList.length}'),
                                                                        switchAdmin:
                                                                            dataTableUserRecord.isAdmin,
                                                                        usuario:
                                                                            dataTableUserRecord.reference,
                                                                      ),
                                                                    ),
                                                                    Align(
                                                                      alignment: AlignmentDirectional(
                                                                          ...
                                                                          0.00),
                                                                      child:
                                                                          SwitchEmpleadoWidget(
                                                                        key: Key(
                                                                            'Key3v8_${dataTableIndex}_of_${dataTableUserRecordList.length}'),
                                                                        switchEmpleado:
                                                                            dataTableUserRecord.isVendedor,
                                                                        usuario:
                                                                            dataTableUserRecord.reference,
                                                                      ),
                                                                    ),
                                                                    Align(
                                                                      alignment: AlignmentDirectional(
                                                                          ...
                                                                          0.00),
                                                                      child:
                                                                          SwitchDeliveryWidget(
                                                                        key: Key(
                                                                            'Keym4y_${dataTableIndex}_of_${dataTableUserRecordList.length}'),
                                                                        switchDelivery:
                                                                            dataTableUserRecord.isDelivery,
                                                                        usuario:
                                                                            dataTableUserRecord.reference,
                                                                      ),
                                                                    ),
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            var confirmDialogResponse = await showDialog<bool>(
                                                                                  ...
                                                                                  builder: (alertDialogContext) {
                                                                                    return AlertDialog(
                                                                                      content: Text('¿Desea eliminar este usuario?'),
                                                                                      actions: [
                                                                                        TextButton(
                                                                            ...
                                                                            if (confirmDialogResponse) {
                                                                              await dataTableUserRecord.reference.delete();
                                                                            } else {
                            ...
                            if (FFAppState().busquedaActiva == true)
                              Expanded(
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                                                ...
                                                                [
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    child:
                                                                        SwitchAdminWidget(
                                                                      key: Key(
                                                                          'Keymzb_${usuariosIndex}_of_${usuarios.length}'),
                                                                      switchAdmin:
                                                                          usuariosItem
                                                                              .isAdmin,
                                                                      usuario:
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    child:
                                                                        SwitchEmpleadoWidget(
                                                                      key: Key(
                                                                          'Keyqds_${usuariosIndex}_of_${usuarios.length}'),
                                                                      switchEmpleado:
                                                                          usuariosItem
                                                                              .isVendedor,
                                                                      usuario:
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    child:
                                                                        SwitchDeliveryWidget(
                                                                      key: Key(
                                                                          'Keyhfy_${usuariosIndex}_of_${usuarios.length}'),
                                                                      switchDelivery:
                                                                          usuariosItem
                                                                              .isDelivery,
                                                                      usuario:
