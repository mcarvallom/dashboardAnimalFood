...
class _EditarCategoriaWidgetState extends State<EditarCategoriaWidget> {
  ...
  void initState() {
    ...
    _model.nombreTextController ??=
        TextEditingController(text: widget.idCategoria?.nombre);
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              ...
                                              if (selectedMedia != null &&
                                                  selectedMedia.every((m) =>
                                                      validateFileFormat(
                                                          ...
                                                          context))) {
                                                safeSetState(() => _model
                                                        .isDataUploading_editarimgCategorialocal =
                                                    true);
                                                ...
                                                try {
                                                  ...
                                                  _model.isDataUploading_editarimgCategorialocal =
                                                      false;
                                                }
                                                if (selectedUploadedFiles
                                                  ...
                                                  safeSetState(() {
                                                    _model.uploadedLocalFile_editarimgCategorialocal =
                                                        selectedUploadedFiles
                                                            .first;
                                                  });
                                                } else {
                                              ...
                                              _model.editarimgCategoria =
                                                ...
                                                file: _model
                                                    .uploadedLocalFile_editarimgCategorialocal,
                                              );
