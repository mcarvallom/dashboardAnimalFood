...
class _InicioWidgetState extends State<InicioWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      safeSetState(() {
        FFAppState().clearUserLogeadoCache();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRow> inicioUserRowList = snapshot.data!;

        final inicioUserRow =
            inicioUserRowList.isNotEmpty ? inicioUserRowList.first : null;
                        ...
                        RefreshIndicator(
                          onRefresh: () async {
                            await Future.wait([
                              ...
                              Future(() async {
                                safeSetState(() {
                                  FFAppState().clearProductosmasvendidosCache();
                              ...
                              Future(() async {
                                safeSetState(() {
                                  _model.clearProductoCacheKey(
                                      _model.requestLastUniqueKey6);
                                                            ...
                                                            return Text(
                                                              valueOrDefault<
                                                                ...
                                                                '\$${functions.ponerPuntoalMil(valueOrDefault<String>(
                                                                  functions
                                                                      .sumar(textProductosmasvendidosmesRowList
                                                                          .where((e) =>
                                                                              dateTimeFormat(
                                                                                "d",
                                                                                e.createdAt,
                                                              ...
                                                              Align(
                                                                ...
                                                                child: FutureBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final nombreProductoMasvendidoProductoRow = nombreProductoMasvendidoProductoRowList
                                                                            .isNotEmpty
                                                                        ? nombreProductoMasvendidoProductoRowList
                                                                            .first
                                                                        : null;
                                                                ...
                                                                child:
                                                                  ...
                                                                  backgroundColor:
                                                                      FlutterFlowTheme.of(
                                                                          ...
                                                                          .accent4,
                                                                  center: Text(
                                                                    '${functions.decimalAEnteroPorcentaje(productoMasvendidoItem.porcentajeVentas).toString()}%',
                                                                    textAlign:
                                                                        TextAlign
                                                                            .center,
                                                                    style: FlutterFlowTheme.of(
                                                              ...
                                                              Align(
                                                                alignment:
                                                                    AlignmentDirectional(
                                                                        ...
                                                                        0.0),
                                                                child: Text(
                                                                  '\$${functions.ponerPuntoalMil(productoMasvendidoItem.ganancia!.toString())}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
