...
import '/pages/ordenes/componentes/cargando_ordenes/cargando_ordenes_widget.dart';
import '/pages/ordenes/componentes/detalle_orden/detalle_orden_widget.dart';
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: FutureBuilder<List<OrdenRow>>(
                          future: _model
                              .ordenes(
                            requestFn: () => OrdenTable().queryRows(
                              queryFn: (q) => q
                                  .eqOrNull(
                                    'empresa',
                                    3,
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData) {
                              return CargandoOrdenesWidget();
                            }
                            List<OrdenRow> columnOrdenRowList = snapshot.data!;

                            if (columnOrdenRowList.isEmpty) {
                              return Container(
                            ...
                            return RefreshIndicator(
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children:
                                      List.generate(columnOrdenRowList.length,
                                              (columnIndex) {
                                    final columnOrdenRow =
                                        columnOrdenRowList[columnIndex];
                                    return InkWell(
